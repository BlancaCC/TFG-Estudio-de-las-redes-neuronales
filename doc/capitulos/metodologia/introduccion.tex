...
el trabajo siguiendo un desarrollo ágil, de acorde a las siguientes hipótesis. 
...
\subsubsection*{[HU05] Finalizar memoria a tiempo y sin que quede nada pendiente} \label{HUO5}
...
\subsubsection*{[HU06] Requisitos tribunal} \label{HUO6}
...
\begin{enumerate}
    ...
    \item Metodología. 
    \item Estudio de las redes neuronales. 
    \item Fase de planteamiento de hipótesis y experimentación. 
    \item Entrega del proyecto.
\end{enumerate}  

\subsection*{Milestone: Recopilación de bibliografía}
...
\subsection*{Milestone 0: Metodología}
Resuelve la segunda historia de usuario definida en \ref{HUO2}. 
Corresponde a la planificación del trabajo.
Para entregar este milestone, deberá de haberse definido y creado:
\begin{itemize}
    \item Personas.
    \item Historias de usuario.
    \item Milestones.
\end{itemize}
El contenido se reflejará tanto en GitHub como en la memoria.

\subsection*{Milestone 1: Estudio de las redes neuronales}  
Resuelve la tercera historia de usuario recogida en sección \ref{HUO3}.
Este milestone consiste en un estudio de las redes neuronales, el cual se reflejará en varios capítulos y secciones de la memoria. Con secciones como:
\begin{itemize}
    \item Definición y construcción de las redes neuronales.
    \item Análisis del teorema de aproximación universal de las redes neuronales de Hornik, Stinchcombe y White.
\end{itemize}

\subsection*{Milestone 2: Hipótesis de optimización}
Este milestone trata de solucionar el cuarto (\ref{HUO4}) y primera (\ref{HU01}) historias de usuario. 

Su producto será ciertos capítulos de la memoria donde se reflejen
\begin{itemize}
    \item Hipótesis planteadas que puedan optimizar las redes neuronales.
...
\subsection*{Milestone 3: Entrega del proyecto}
Este milestone satisface la quinta (\ref{HUO5}) y sexta (\ref{HUO6}) historias de usuario. 

Su resultado será una memoria revisada y pulida que se entregará en Prado como trabajo fin de grado. 
