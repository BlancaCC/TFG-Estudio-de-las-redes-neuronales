...
\begin{proof}
    ...
    \textcolor{red}{ Ojo con la la q de la fracción, que está en el denominador
    ...
    \textcolor{red}{ (Cambio signos con respecto a la función original)
    \begin{equation}
    ...
    \begin{itemize}
        ...
        \end{equation}
        y por ende, como además $\frac{q-1}{q} \leq F(\lambda) \leq 1$ por cómo se seleccionaron los $r_j$ en 
        \refeq{lema:2_2_seleccion_r_F} se tiene que 
        \begin{equation}
            | F(\lambda) - H_{\epsilon}(\lambda) | < \frac{1}{q} +  \frac{\epsilon}{2q} < \epsilon.
        \end{equation}

        \item Si $\lambda \in (r_{j},r_{j+1}]:$
        \textcolor{red}{Esta parte me tiene mareada y no consigo acotarla de manera clara}
        Tenemos por una parte que $\frac{j}{q} < F(\lambda) \leq \frac{j+1}{q}$ y 
        podemos componer $H_\epsilon$ en las siguientes sumatorias: 
        \begin{equation}
            \begin{split}
                q H_\epsilon(\lambda) 
                = 
        ...
        Los términos de la primera sumatoria serán mayores que $\left(1-\frac{\epsilon}{2q} \right)$, 
        el segundo sumando satisface que 
        $\frac{j}{q} < q\psi( A_{r_j, r_{j+1}}(\lambda)) \leq \frac{j+1}{q}$
        y para la última sumatoria, todos sus términos serán menores que $\frac{\epsilon}{2q} < \frac{\epsilon^2}{4}.$
        \begin{equation}
            (j-1)\left(1-\frac{\epsilon^2}{4} \right) 
            +  
            j\frac{\epsilon}{2} 
            <
            H_\epsilon(\lambda) 
            ...
            (j+1)\frac{\epsilon}{2}
            + 
            (q-j) \frac{\epsilon^2}{4} 
        \end{equation}
        Por lo que $H_\epsilon(\lambda) = \frac{j}{q} + \frac{\gamma}{q} +\mathcal O(\epsilon^2)$
        para $\gamma \in (0,1).$
        Concluyendo que 
        \begin{equation}
            | F(\lambda) - H_{\epsilon}(\lambda) | < \frac{1}{q} +  \mathcal O(\epsilon^2) < \epsilon.
        \end{equation}
    \end{itemize}
