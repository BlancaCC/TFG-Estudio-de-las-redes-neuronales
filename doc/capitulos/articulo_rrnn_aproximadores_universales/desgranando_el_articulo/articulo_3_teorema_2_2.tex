...
\begin{proof}
    ...
    \begin{equation}
        H_{[-\pi, \pi ]} = H_{[-\pi, 0]} + H_{[-\pi, 0]}(-\mu) - 1
        = H_{[-\pi, \pi]} + H_{[-\pi, 0]}(-\mu) - F(\mu + 2 \pi M)
    \end{equation}  
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=.7\textwidth]{articulo_rrnn_aproximadores_universales/ejemplo_H_Grande.png}
    ...
    \begin{equation}
        \begin{split}
        H_{[-2\pi N, 2 \pi N]} (\lambda) &= \sum_{i=1}^N (H_{[-\pi, \pi ]})(\lambda + 2 \pi i) +1)
        + H_{[-\pi, \pi ]}(\lambda)+
        \sum_{i=1}^N (H_{[-\pi, \pi ]})(\lambda - 2 \pi i) +1) \\
        &= \sum_{i=1}^N (H_{[-\pi, \pi ]})(\lambda + 2 \pi i) + F(\lambda + 2 \pi M))\\
        & + H_{[-\pi, \pi ]}(\lambda)\\
        & +\sum_{i=1}^N (H_{[-\pi, \pi ]})(\lambda - 2 \pi i) + F(\lambda + 2 \pi M)).           
    \end{split}
    \end{equation}
