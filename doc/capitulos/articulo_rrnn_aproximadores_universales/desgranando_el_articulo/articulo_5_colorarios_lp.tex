...
\end{proof}
\textcolor{red}{A partir de aquí no ha sido revisado.}
...
\textcolor{red}{Javier, la demostración que vas a leer a continuación se podría hacer directamente sin separar en casos ¿crees que sería mejor atacar directamente en el caso general?}
% Teorema 2.5  
...
\subsection{Reflexión sobre el número de neuronas} 
...
por modelos más simples. ¿Cuántas neuronas \textit{simplificarían} el modelo? Podríamos tomar menos del tamaño del conjunto de 
entrenamiento y utilizar esa \textit{redundancia} para 
\textit{afinar}. 
...
Por ejemplo: queremos construir una rrnn con n neuronas, 
...
\textcolor{red}{Tras la demostración de este teorema, el artículo 
indica literalmente \textit{Con tediosas modificaciones la prueba de este teorema es válida para cualquier función de activación}. Sin embargo no da ninguna indicación ni nada ¿La incluimos?¿Cómo se haría?}