...
%% Lema 
\begin{lema}[Caracterización de la convergencia de una sucesión]
...
Probando con esto que     Para cualquier  $\epsilon > 0$ se tiene que $\mu \{  x : |f_n(x) - f(x)| > \epsilon \} \longrightarrow 0$.
