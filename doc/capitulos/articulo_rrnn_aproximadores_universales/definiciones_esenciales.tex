...
\begin{definicion} [Formalización de una red neuronal con una capa oculta]
...
Denotamos por  $C^r$ al conjunto de funciones continuas con dominio en $\R^r$ y codominio $\R$,
por  $M^r$ al conjunto de todas las funciones Borel medible de $\R^r$ a $\R$. 
...
$\pmc$ y $\pmcg$ pertenecen a $C^r$. Tengamos presente que $C^r$ es un subconjunto
de $M^r$.  
