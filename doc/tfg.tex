...
\setpartpreamble[c][0.75\linewidth]{
	%\bigskip % Deja un espacio vertical en la parte superiọ-r
...
\include{capitulos/teoria_aproximacion/objetivos}
\include{capitulos/teoria_aproximacion/bibliografia}
\include{capitulos/teoria_aproximacion/polinomios_de_Berstenstein}
\include{capitulos/teoria_aproximacion/Weierstrass_approximation_theorem}
\include{capitulos/teoria_aproximacion/TeoremaStoneWeierstrass}

% Redes neuronales
\input{capitulos/introduccion_redes_neuronales/Objetivos}
%\input{capitulos/introduccion_redes_neuronales/bibliografia}
\input{capitulos/introduccion_redes_neuronales/aprendizaje_introduccion}
%\input{capitulos/introduccion_redes_neuronales/perceptron}
\input{capitulos/introduccion_redes_neuronales/feedforward-networks}

% Las redes neuronales multicapa son aproximadores universales 
\include{capitulos/articulo_rrnn_aproximadores_universales/introduccion}
\include{capitulos/articulo_rrnn_aproximadores_universales/desgranando_el_articulo/articulo_1_primeras_definiciones}
\input{capitulos/articulo_rrnn_aproximadores_universales/desgranando_el_articulo/articulo_2_teorema_1_hasta_lema_2_2}
\input{capitulos/articulo_rrnn_aproximadores_universales/desgranando_el_articulo/articulo_3_teorema_2_2}
\input{capitulos/articulo_rrnn_aproximadores_universales/desgranando_el_articulo/articulo_4_colorario_2_1}
\include{capitulos/articulo_rrnn_aproximadores_universales/desgranando_el_articulo/articulo_5_colorarios_lp}
\include{capitulos/articulo_rrnn_aproximadores_universales/desgranando_el_articulo/articulo_6_multi_output}
\include{capitulos/articulo_rrnn_aproximadores_universales/conclusiones_finales}
% Cajón desastre 
\part{Experimentación}
%\include{capitulos/ideas/objetivos}
%\include{capitulos/ideas/recurrencias_continuas_en_varias_dimensiones}
%\include{capitulos/ideas/numero_capas_ocultas}
\part{Metodología}
%Metodología 
\include{capitulos/metodologia/introduccion}
\include{capitulos/metodologia/registroHorasTrabajo}
% --------------------------------------------------------------------
% APPENDIX: Opcional
% --------------------------------------------------------------------
