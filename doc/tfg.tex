...
% --- Capítulos teoría de la aproximación 
...
% ----- Cápitulo redes neuronales ------
\include{capitulos/conceptos_basico_redes_neuronales/bibliografia.tex}
\include{capitulos/conceptos_basico_redes_neuronales/definicion_aprendizaje.tex}
% --------------------------------------------------------------------
% APPENDIX: Opcional
% --------------------------------------------------------------------
