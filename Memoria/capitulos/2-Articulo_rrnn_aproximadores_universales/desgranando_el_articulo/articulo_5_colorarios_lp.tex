...
cualquier función de la clase recién introducida cuyo dominio parta de $[0,1]^r$, es decir \textbf{se está concretando los valores de entrada que pueden tomar las funciones}.
}
\begin{proof}
...
\marginpar{
  ...
  La demostración es totalmente constructiva 
  dando las claves de cómo conseguir una red neuronal 
  que tome ciertos valores concretos.
  A nivel práctico si queremos que una red neuronal de una capa oculta
  con $n$ neuronas aprenda se deberán de ir refinando los pesos iniciales con el algoritmo de gradiente 
    descendente. Sabemos que los valores iniciales condicionan el 
    resultado final del entrenamiento, por lo que 
    \textbf{tomar  como red inicial la construida con la fórmula que nos da 
    esta demostración y $n$ datos aleatorios, podría ser una buena 
    heurística}.  
}
\normalmarginpar
\begin{itemize}
