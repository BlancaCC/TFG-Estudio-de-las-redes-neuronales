...
la selección de nuestro modelo en las sección \ref{ch05:justifica-modelo}.
...
\end{itemize}
Lo que hace un total de $n(s+d+1)$ parámetros, done $n$ es el número de neuronas, $s$ la dimensión de salida y $d$ la dimensión de entrada. 
...
es un aproximados universal del teorema \ref{teo:MFNAUA}. 
...
\marginpar{\maginLetterSize
    ...
    vista a la implementación. Tal estructura definirá
     ...
     otro, de esta manera se tendrá una mayor flexibilidad en la arquitectura y un ahorre en memoria. 
