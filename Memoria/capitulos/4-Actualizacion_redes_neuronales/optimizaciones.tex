...
Cuando se carecen de \textit{backbones} o no es posible utilizarlos, una buena técnica para dar un valor inicial  a los pesos consiste en basarse en metaheurísticas tales como algoritmos genéticos,
...
\begin{itemize}
    ...
    \item Para funciones del tipo anterior, pero asintóticas a $a,b \in \R$, con alguno de los extremos $a,b$ distintos de $0$ y $1$, bastará con realizar una transformación afín $f$ cumpliendo que $f(a)= 0$ y $f(b)= 1$ y aplicar teorema \ref{teo:eficacia-funciones-activation}. 
\end{itemize}
