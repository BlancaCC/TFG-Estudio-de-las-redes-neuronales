...
Pero como hemos observado en el coste en memoria de ir almacenando los resultados parciales \ref{tab:expresiones_repetidas_en_descenso_gradiente}
el coste en memoria de nuestro algoritmo sería de $s + n(1+s)$ 
Así pues se acaba de probar que un algoritmo directo es peor en coste de cálculo y memoria frente a otro que almacene los resultados parciales. 

Por lo que los algoritmos que proponemos a continuación se basarán en almacenar estos resultados. 

\textcolor{red}{ Revisar una vez hecho el algoritmo} porque creo que el coste de almacenar las parciales es inamovible (o no).
