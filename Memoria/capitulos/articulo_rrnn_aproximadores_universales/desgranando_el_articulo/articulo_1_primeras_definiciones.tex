...
\begin{definicion}[Función de activación ] \label{def:funcion_activacion_articulo}
    ...
    \begin{itemize}
        ...
        \begin{equation}
            ...
            \right.
        \end{equation}
        %%% Nota sobre importancia función activación
        \marginpar{
            Las funciones de activación son la clave del aprendizaje de las redes neuronales
            ya que realizan transformaciones significativas de lo datos.
        }
        \StoryNote{
        Las funciones de activación son la clave del aprendizaje de las redes neuronales
        ya que realizan transformaciones significativas de los datos.
        }{hola}
