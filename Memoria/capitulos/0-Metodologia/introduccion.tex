...
El objetivo es  \textit{optimizar las redes neuronales} en base de
un fundamento matemático sólido y sistemático que provenga de
la nocción más elemental de red neuronal y no meras heurísticas experimentales.
...
\section{Personas definidas}  \label{ch:metodología_personas}
...
\subsection*{Milestone 1: Búsqueda de resultados teóricos para optimizar  las redes neuronales}
