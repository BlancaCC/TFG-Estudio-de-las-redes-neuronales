...
\begin{equation} \label{eq:conjuntos-redes-neuronales-con-sesgo-contiene-elemental}
    \mathcal{H}(X,Y) \subsetneq \mathcal{H}^+(X,Y)
\end{equation}
...
\end{equation}
esta relación nos hace reparar que la precisión que pueda aportar el sesgo es
...
% Fin de la demostración 
 ...
 Concluimos por tanto que aunque la precisión es diferente para un mismo número de neuronas, añadiendo una más el sesgo es irrelevante y además aumenta la complejidad, por lo que deducimos 
