...
Durante cada iteración los datos del conjunto han sido desordenados. 

Los resultados obtenidos han sido los siguientes: 

Y donde el test de los signos de Wilcoxon ha rechazado la hipótesis nula con un $95\%$ de confianza. 
