...
Que tendrá como resultado la siguiente salida: 
...
\subsection{ Uso de los tipos de datos y \textit{ dispatch methods}}
...
\subsection{Tipo de datos de variables auxiliares}

\section{Diseño de los tests} 
