...
% Forward propagtion 
\input{capitulos/1-Introduccion_redes_neuronales/construccion-evaluacion-red-neuronal}

% Teoría de la aproximación 
\input{capitulos/3-Teoria_aproximacion/objetivos}
\input{capitulos/3-Teoria_aproximacion/polinomios_de_Berstenstein}
\input{capitulos/3-Teoria_aproximacion/Weierstrass_approximation_theorem}
\input{capitulos/3-Teoria_aproximacion/TeoremaStoneWeierstrass}
