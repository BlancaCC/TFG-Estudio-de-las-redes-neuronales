...
\input{capitulos/1-Introduccion_redes_neuronales/feedforwar-network-una-capa}
\input{capitulos/1-Introduccion_redes_neuronales/feedforward-networks}
...
\include{capitulos/2-Articulo_rrnn_aproximadores_universales/desgranando_el_articulo/articulo_5_colorarios_lp}
\include{capitulos/2-Articulo_rrnn_aproximadores_universales/desgranando_el_articulo/articulo_6_multi_output}
%\include{capitulos/2-Articulo_rrnn_aproximadores_universales/conclusiones_finales}

% Teoría de la aproximación 
\include{capitulos/3-Teoria_aproximacion/objetivos}
\include{capitulos/3-Teoria_aproximacion/bibliografia}
\include{capitulos/3-Teoria_aproximacion/polinomios_de_Berstenstein}
\include{capitulos/3-Teoria_aproximacion/Weierstrass_approximation_theorem}
\include{capitulos/3-Teoria_aproximacion/TeoremaStoneWeierstrass}
...
\input{capitulos/4-Actualizacion_redes_neuronales/backpropagation}
